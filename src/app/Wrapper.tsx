...
const Wrapper = () => {
  ...
  return (
    ...
    //         }  h-[100dvh] w-full flex-col bg-white dark:bg-[#010101] transition-all duration-500`}
    //       >
    ...
    //   </div> */}
    //       <button
    //         className="absolute md:w-16 md:h-16 w-10 h-10 md:bottom-16 bottom-5 md:right-16 right-5 bg-neutral-900 dark:bg-white rounded-full text-white dark:text-black font-semibold md:text-[16px] text-[10px]"
    ...
    //         className={`${
    //           isOpen ? "fixed top-[90%]" : "fixed top-0"
    //         }  h-[100dvh] items-center flex justify-center w-full flex-col bg-white dark:bg-[#010101] transition-all duration-500 gap-5`}
    //       >
    //         <Image
    //           src="/images/logo.svg"
    //           alt="Logo"
